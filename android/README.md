...
- JDK 17–24 для Gradle 8.9 (рекомендуется)
- JDK 25+ требует Gradle 9.0.0 (текущая версия wrapper; AGP 8.7.3 официально рассчитан на Gradle 8.x, lint может не работать)
